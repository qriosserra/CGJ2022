package fr.lost_in_dark.game.framebuffer;
...
public class SceneBuffer {
    ...
    public SceneBuffer(Window window) throws Exception {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB32F, window.getWidthFramebuffer(), window.getHeightFramebuffer(), 0, GL_RGB, GL_FLOAT, (ByteBuffer) null);
    ...
    public void bind() {
        GL30.glBindFramebuffer(GL30.GL_FRAMEBUFFER, this.getBufferId());
    }
