...
public class Dialog implements Serializable {
     ...
     * @param dialogText the dialog text to load
     * @param saveStateDirectory the directory used to save the states of this dialog
     */
    public Dialog(String dialogText, File saveStateDirectory) throws IOException {
    ...
    public void loadDialog() throws IOException {
        ...
        Scanner scanner = new Scanner(this.dialogText);
        ...
        while (scanner.hasNextLine()) {
            ...
            if (line.startsWith("#")) {
                ...
                this.dialogPartCount.put(simpleKey, 1);
                ...
                for (String mission : missions) {
                    this.missions.get(key).put(mission, false);
                }
